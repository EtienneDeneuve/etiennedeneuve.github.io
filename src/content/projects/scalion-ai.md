...
decisions_en:
  - "Start from real technical signals (code, cloud, K8s, runtime) rather than static diagrams"
  - "Link dependencies, risk and decision in one model"
  - "Model before automating"
principles:
  - "Modéliser avant d’automatiser"
  - "Réduire la charge cognitive par une carte actionnable"
  - "Traçabilité des dépendances et du risque"
principles_en:
  - "Model before automating"
  - "Reduce cognitive load with an actionable map"
  - "Traceability of dependencies and risk"
whatExists:
  - "Modèle produit et architecture en cours (non publié)"
  - "Cadre de cartographie SI / risque (travail interne)"
whatExists_en:
...
limitations_en:
  - "No public product site"
  - "No product metrics or market claims"
learnings:
  - "Une carte utile doit servir une décision, pas remplir un dashboard"
  - "Le risque sans modèle de dépendances reste théorique"
learnings_en:
  - "A useful map must serve a decision, not fill a dashboard"
  - "Risk without a dependency model stays theoretical"
relatedArticles:
